    ...
    const evaluationReports: EvaluationReport[] = [
      {
        ...
        topicStats: {
          'Number Sense': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } },
          'Number Operations': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } }
        },
      ...
      },
      {
        ...
        topicStats: {
          'Measurement': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } }
        },
      ...
      },
      {
        ...
        topicStats: {
          'Patterns': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } }
        },
      ...
      },
      {
        ...
        topicStats: {
          'Number Sense': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } },
          'Measurement': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } },
          'Money': { easy: { total: 0, correct: 0 }, medium: { total: 1, correct: 0 }, hard: { total: 0, correct: 0 } }
        },
      ...
      },
      {
        ...
        topicStats: {
          'Fractions': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } },
          'Money': { easy: { total: 1, correct: 1 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } }
        },
      ...
      },
      {
        ...
        topicStats: {
          'Number Sense': { easy: { total: 2, correct: 2 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } },
          'Shapes': { easy: { total: 2, correct: 2 }, medium: { total: 0, correct: 0 }, hard: { total: 0, correct: 0 } },
          'Fractions': { easy: { total: 1, correct: 1 }, medium: { total: 1, correct: 0 }, hard: { total: 0, correct: 0 } }
        },
