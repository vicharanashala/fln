...
import { UserRole } from '../backend/src/db';
import { STATES_UTS } from '../backend/src/geoData';
import questionBankSeed from '../backend/src/data/question_bank_seed.json';

const SEED_PASSWORD_HASH = bcrypt.hashSync('Fln@2026', 10);


// ============================================================
// NAME POOLS ΓÇö 250+ realistic Indian names
// ============================================================
...
// ============================================================
// SCHOOL AREA NAMES ΓÇö used in "GPS <Area> <City>" format
// ============================================================
...
// ============================================================
// SEED QUESTIONS ΓÇö 12 questions (6 levels ├ù 2 each)
// ============================================================
...
async function main() {
  ...
  // ΓöÇΓöÇ Drop all existing collections ΓöÇΓöÇ
  ...
  // ΓöÇΓöÇ Accumulate all documents ΓöÇΓöÇ
  ...
  // ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
  // 2. STATES / UTs ΓåÆ Districts ΓåÆ Blocks ΓåÆ Schools ΓåÆ Classes ΓåÆ Students
  // ΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉΓòÉ
    ...
    for (let dIdx = 0; dIdx < state.districts.length; dIdx++) {
      ...
      for (let bIdx = 0; bIdx < 2; bIdx++) {
        ...
        for (let sIdx = 0; sIdx < 10; sIdx++) {
          ...
          // ΓöÇΓöÇ Principal (School role) ΓöÇΓöÇ
          allUsers.push({
            id: `u_prn_${schoolId}`,
          ...
          // ΓöÇΓöÇ 3 Teachers (one per class) ΓöÇΓöÇ
          ...
          // ΓöÇΓöÇ Volunteer for low-strength schools ΓöÇΓöÇ
          if (isLowStrength) {
            allUsers.push({
              id: `u_vol_${schoolId}`,
          ...
          // ΓöÇΓöÇ 3 Classes (Class 2, 3, 4) ΓöÇΓöÇ
          for (let cIdx = 0; cIdx < 3; cIdx++) {
            ...
            // ΓöÇΓöÇ 20 Students per class ΓöÇΓöÇ
