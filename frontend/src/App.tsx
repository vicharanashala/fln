...
import { IcrScanner } from './components/IcrScanner';
              ...
              >
                ...
                {activePanel === 'evaluation' && (
                  <IcrScanner
                    token={token}
                    user={currentUser}
                    onBack={() => setActivePanel('workspace')}
                  />
                )}
                ...
                {!['workspace', 'logbook', 'tickets', 'calendar', 'settings', 'notifications', 'evaluation'].includes(activePanel) && (
