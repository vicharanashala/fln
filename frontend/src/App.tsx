...
export default function App() {
  ...
  const handleSelectView = (panel: string) => {
    if (
      panel === 'dashboard' ||
      panel === 'overview'
    ) {
  ...
  const activeUrgentAnnouncements =
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3 rounded-lg border border-slate-100 bg-slate-50 p-4">
                            ...
                            <label className="flex items-center gap-2 font-medium">
                              ...
                              <span>
                                Enable High-Contrast Border Outlines
                              </span>
                            </label>
                            ...
                            <label className="flex items-center gap-2 font-medium">
                              ...
                              <span>
                                Audio voice narration on hover (SLA §2.3)
                              </span>
                            </label>
