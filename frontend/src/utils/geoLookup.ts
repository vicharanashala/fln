...
export const MASTER_GEO_DATA: { stateCode: string; stateName: string; districtCode: string; districtName: string }[] = [
  ...
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'ASR_AP', districtName: 'Alluri Sitharama Raju' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'AKP', districtName: 'Anakapalli' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'ATP', districtName: 'Ananthapuramu' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'ANN', districtName: 'Annamayya' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'BPT', districtName: 'Bapatla' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'CTR_AP', districtName: 'Chittoor' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'KNS', districtName: 'Dr. B.R. Ambedkar Konaseema' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'EGD', districtName: 'East Godavari' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'ELR', districtName: 'Eluru' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'GNT', districtName: 'Guntur' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'KKD_AP', districtName: 'Kakinada' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'KRI', districtName: 'Krishna' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'KRN', districtName: 'Kurnool' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'NDL', districtName: 'Nandyal' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'NTR', districtName: 'NTR / Vijayawada' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'PLN', districtName: 'Palnadu' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'PVM', districtName: 'Parvathipuram Manyam' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'PRK', districtName: 'Prakasam' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'NLR', districtName: 'Sri Potti Sriramulu Nellore' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'SSS', districtName: 'Sri Sathya Sai' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'SKL', districtName: 'Srikakulam' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'TPT', districtName: 'Tirupati' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'VSP', districtName: 'Visakhapatnam' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'VZM', districtName: 'Vizianagaram' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'WGD', districtName: 'West Godavari' },
  { stateCode: 'AP', stateName: 'Andhra Pradesh', districtCode: 'YSR', districtName: 'YSR Kadapa' },
  // Arunachal Pradesh (AR) - 27 Districts
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'TWG', districtName: 'Tawang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'WKM', districtName: 'West Kameng' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'EKM_AR', districtName: 'East Kameng' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'PPR', districtName: 'Papum Pare' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'ICC', districtName: 'Itanagar Capital Complex' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'KDK', districtName: 'Kra Daadi' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'LSD', districtName: 'Kurung Kumey' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'CSG', districtName: 'Lower Subansiri' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'PAX', districtName: 'Pakke Kessang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'KNG_AR', districtName: 'Kamle' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'LDR', districtName: 'Upper Subansiri' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'UHB', districtName: 'West Siang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'LHB', districtName: 'Shi Yomi' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'WSG', districtName: 'Siang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'ESG', districtName: 'Upper Siang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'SSG', districtName: 'Lower Siang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'UDG', districtName: 'Leparada' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'NMS', districtName: 'East Siang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'SLG', districtName: 'Dibang Valley' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'TNG', districtName: 'Lower Dibang Valley' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'ANW', districtName: 'Anjaw' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'LDG', districtName: 'Lohit' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'DVB', districtName: 'Namsai' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'TIR', districtName: 'Changlang' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'CGL_AR', districtName: 'Tirap' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'LGD', districtName: 'Longding' },
  { stateCode: 'AR', stateName: 'Arunachal Pradesh', districtCode: 'BMR_AR', districtName: 'Bichom' },
  // Assam (AS) - All 35 Official Districts
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'BJL', districtName: 'Bajali' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'BKS', districtName: 'Baksa' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'BRP', districtName: 'Barpeta' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'BSW_AS', districtName: 'Biswanath' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'BNG_AS', districtName: 'Bongaigaon' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'CCH', districtName: 'Cachar' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'CRD', districtName: 'Charaideo' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'CRG', districtName: 'Chirang' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'DRG_AS', districtName: 'Darrang' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'DMJ', districtName: 'Dhemaji' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'DHB', districtName: 'Dhubri' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'DBR', districtName: 'Dibrugarh' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'DMH_AS', districtName: 'Dima Hasao' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'GLP', districtName: 'Goalpara' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'GLT', districtName: 'Golaghat' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'HLK', districtName: 'Hailakandi' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'HOJ', districtName: 'Hojai' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'JRH', districtName: 'Jorhat' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'KRM', districtName: 'Kamrup Metropolitan' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'KRR_AS', districtName: 'Kamrup Rural' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'KBA', districtName: 'Karbi Anglong' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'KMG', districtName: 'Karimganj' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'KKR_AS', districtName: 'Kokrajhar' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'LKP_AS', districtName: 'Lakhimpur' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'MJL', districtName: 'Majuli' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'MRG', districtName: 'Morigaon' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'NGN', districtName: 'Nagaon' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'NLB', districtName: 'Nalbari' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'SVS', districtName: 'Sivasagar' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'SNT', districtName: 'Sonitpur' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'SSM', districtName: 'South Salmara-Mankachar' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'TMP', districtName: 'Tamulpur' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'TSK', districtName: 'Tinsukia' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'UDL', districtName: 'Udalguri' },
  { stateCode: 'AS', stateName: 'Assam', districtCode: 'WKA', districtName: 'West Karbi Anglong' },
  ...
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BLD_CG', districtName: 'Balod' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BDB', districtName: 'Baloda Bazar' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BLR_CG', districtName: 'Balrampur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BST_CG', districtName: 'Bastar' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BMT', districtName: 'Bemetara' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BJP', districtName: 'Bijapur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'BLP_CG', districtName: 'Bilaspur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'DTW', districtName: 'Dantewada / South Bastar' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'DHM', districtName: 'Dhamtari' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'DRG', districtName: 'Durg' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'GRB', districtName: 'Gariaband' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'GPM', districtName: 'Gaurela-Pendra-Marwahi' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'JJC', districtName: 'Janjgir-Champa' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'JSP_CG', districtName: 'Jashpur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'KBD', districtName: 'Kabirdham / Kawardha' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'KNK', districtName: 'Kanker / North Bastar' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'KCG', districtName: 'Khairagarh-Chhuikhadan-Gandai' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'KDG_CG', districtName: 'Kondagaon' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'KRB', districtName: 'Korba' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'KRY', districtName: 'Koriya' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'MSM', districtName: 'Mahasamund' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'MCB', districtName: 'Manendragarh-Chirmiri-Bharatpur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'MMA', districtName: 'Mohla-Manpur-Ambagarh Chowki' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'MGL', districtName: 'Mungeli' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'NRP', districtName: 'Narayanpur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'RGH', districtName: 'Raigarh' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'RPR', districtName: 'Raipur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'RJN', districtName: 'Rajnandgaon' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'SKT', districtName: 'Sakti' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'SGB', districtName: 'Sarangarh-Bilaigarh' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'SKM', districtName: 'Sukma' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'SRJ', districtName: 'Surajpur' },
  { stateCode: 'CG', stateName: 'Chhattisgarh', districtCode: 'SRG', districtName: 'Surguja' },
  // Goa (GA) - 2 Districts
  { stateCode: 'GA', stateName: 'Goa', districtCode: 'NG', districtName: 'North Goa' },
  { stateCode: 'GA', stateName: 'Goa', districtCode: 'SG', districtName: 'South Goa' },
...
const DISTRICT_LOOKUP: Record<string, { code: string; name: string; stateCode: string; stateName: string }> = {
  ...
  kawardha: { code: 'KBD', name: 'Kabirdham / Kawardha', stateCode: 'CG', stateName: 'Chhattisgarh' },
  kabirdham: { code: 'KBD', name: 'Kabirdham / Kawardha', stateCode: 'CG', stateName: 'Chhattisgarh' },
  dantewada: { code: 'DTW', name: 'Dantewada / South Bastar', stateCode: 'CG', stateName: 'Chhattisgarh' },
  kanker: { code: 'KNK', name: 'Kanker / North Bastar', stateCode: 'CG', stateName: 'Chhattisgarh' },
  bilaspur_cg: { code: 'BLP_CG', name: 'Bilaspur', stateCode: 'CG', stateName: 'Chhattisgarh' },
  jashpur: { code: 'JSP_CG', name: 'Jashpur', stateCode: 'CG', stateName: 'Chhattisgarh' },
  balrampur_cg: { code: 'BLR_CG', name: 'Balrampur', stateCode: 'CG', stateName: 'Chhattisgarh' },
