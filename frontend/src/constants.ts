...
export const DISTRICT_NAMES: Record<string, string> = {
  ...
  PLI: 'Pali', PHL: 'Phalodi', PRT_RJ: 'Pratapgarh', RJS: 'Rajsamand', SLB: 'Salumbar',
  SNC: 'Sanchore', SWM: 'Sawai Madhopur', SHP: 'Shahpura', SKR: 'Sikar', SRH: 'Sirohi',
  TNK: 'Tonk', UDP: 'Udaipur',
  AN: 'Andaman and Nicobar Islands', CH: 'Chandigarh', DN: 'Dadra and Nagar Haveli',
  DD: 'Daman and Diu', DL: 'Delhi', JK: 'Jammu and Kashmir', LA: 'Ladakh', PY: 'Puducherry',
};
...
export const BLOCK_NAMES: Record<string, string> = {
  ...
  'UDP_01': 'Badgaon Block', 'UDP_02': 'Bhindar Block', 'UDP_03': 'Girwa Block', 'UDP_04': 'Gogunda Block', 'UDP_05': 'Jhadol Block', 'UDP_06': 'Kanore Block', 'UDP_07': 'Kherwara Block', 'UDP_08': 'Kotra Block', 'UDP_09': 'Kurabad Block', 'UDP_10': 'Mavli Block', 'UDP_11': 'Rishabhdeo Block', 'UDP_12': 'Sayra Block', 'UDP_13': 'Vallabhnagar Block',
