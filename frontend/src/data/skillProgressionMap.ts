...
export const CORE_SKILLS: CoreSkill[] = [
  ...
  { id: 'SK11', name: 'Place Value & Base-Ten Structure', domain: 'Number Sense',
    ...
    subskills: [
      ...
      { id: 'SK11.10', name: 'Face value', observable: true },
    ]},
  ...
  { id: 'SK15', name: 'Multiplication', domain: 'Number Operations',
    ...
    subskills: [
      ...
      { id: 'SK15.08', name: 'Factors and multiples', observable: true },
    ]},
  ...
  { id: 'SK17', name: 'Fractions', domain: 'Fractions',
    ...
    subskills: [
      ...
      { id: 'SK17.06', name: 'Decimal notation (tenths and hundredths)', observable: true },
    ]},
